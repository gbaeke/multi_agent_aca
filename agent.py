...
class StreamingAgent:
    ...
    def __init__(
        ...
        instructions: str = "You are a helpful assistant. Respond in a friendly and informative manner.",
...
# Create a default streaming agent instance
streaming_agent = StreamingAgent()

# Keep the simple agent for backward compatibility
simple_agent = Agent(
    name="SimpleAgent",
    instructions="You are a helpful assistant. Respond in a friendly and informative manner.",
    model="gpt-4o-mini",
